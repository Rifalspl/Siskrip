...
public class FormLoginAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "LOGIN DISINI", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 18), new java.awt.Color(255, 203, 97))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblPesan, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    if (username.isEmpty() || password.isEmpty()) {
        lblPesan.setText("Username dan password harus diisi!");
        return;
    }
    ...
    try {
        ...
        if (rs.next()) {
            // Login sukses
            lblPesan.setText("Login berhasil, selamat datang Admin!");
        ...
        lblPesan.setText("Error: " + ex.getMessage());
    }
    ...
    // Buka form registrasi admin
    FormRegistrasiAdmin reg = new FormRegistrasiAdmin();
    reg.setVisible(true);
    this.dispose(); // tutup form login
